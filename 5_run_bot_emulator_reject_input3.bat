...
title Bot Emulator Reject Input 3 Runner
echo ========================================================
echo      MENJALANKAN BOT EMULATOR REJECT INPUT 3
echo ========================================================
echo.
...
echo [2/2] Memulai bot emulator reject input 3...
echo.

python bot_emulator_reject_input3.py
