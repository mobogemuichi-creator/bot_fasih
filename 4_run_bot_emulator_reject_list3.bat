...
title Bot Emulator Reject List 3 Runner
echo ========================================================
echo       MENJALANKAN BOT EMULATOR REJECT LIST 3
echo ========================================================
echo.
...
echo [2/2] Memulai bot emulator reject list 3...
echo.

python bot_emulator_reject_list3.py
