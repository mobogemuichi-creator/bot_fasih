...
title Bot Emulator Reject List 2 Runner
echo ========================================================
echo       MENJALANKAN BOT EMULATOR REJECT LIST 2
echo ========================================================
echo.
...
echo [2/2] Memulai bot emulator reject list 2...
echo.

python bot_emulator_reject_list2.py
