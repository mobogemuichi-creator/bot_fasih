...
def hubungkan_emulator():
    """Menghubungkan uiautomator2 ke emulator LDPlayer (Instance 3)"""
    global d
    print("[KONEKSI] Menghubungkan ke emulator instance 3...")
...
def salin_reject_ke_excel(file_txt="reject3.txt", file_excel=None):
    """
    Menyalin data dari reject3.txt ke file data_reject3.xlsx.
