...
try:
    from konfigurasi import EXCEL_FILE_REJECT as EXCEL_FILE
except ImportError:
    EXCEL_FILE = "data_reject.xlsx"
...
def hubungkan_emulator():
    """Menghubungkan uiautomator2 ke emulator LDPlayer (Instance 1)"""
    global d
    print("[KONEKSI] Menghubungkan ke emulator instance 1...")
...
def salin_reject_ke_excel(file_txt="reject.txt", file_excel=None):
    """
