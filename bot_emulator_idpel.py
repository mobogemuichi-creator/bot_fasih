...
def main():
    ...
    for row in range(2, sheet.max_row + 1):
        ...
        if status_exist in ["SUKSES", "Error : SUDAH TERCATAT PADA SISTEM FASIH", "Error : Nik tidak valid", "Error : data alamat server kosong", "Error : id pelanggan tidak ditemukan", "Error : nama tidak murni alphabeth"]:
